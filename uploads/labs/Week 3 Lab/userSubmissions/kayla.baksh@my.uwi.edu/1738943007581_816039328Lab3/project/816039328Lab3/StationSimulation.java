...
public class StationSimulation{
    public static void main(String[] args){
        for (int i = 0; i < 10; i++){
            Vehicle v = new Vehicle(getRandomNumber(1, 20), getRandomNumber(1,5), getRandomNumber(1,5), getRandomNumber(1, 5));
        ...
        for(int i = 0; i < 10; i++){
            vehicles.add(
                new Vehicle(
                    getRandomNumber(1, 20), getRandomNumber(1,5), getRandomNumber(1,5), getRandomNumber(1, 5)
                )
            );
        }
        ...
        for(VehicleDriver driver:drivers){
            ...
            driver.addVehicle(v);
            //this only does up to first vehicle
            //so lets do second
            do{
