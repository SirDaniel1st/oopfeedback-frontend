public class Vehicle {
  ...
  public Vehicle(int length, int width, int breadth) {
    ...
    if (this.tankCapacity % 2 == 0) this.fuelType = "gasoline";
    else this.fuelType = "diesel";
  }
    
  public int getTankCapacity() {return this.tankCapacity;}
  public String getFuelType() {return this.fuelType;}
  public String toString() {
    return ("VEHICLE TANK CAPACITY: " + String.format("%d", this.tankCapacity) + " FUEL TYPE: " + this.fuelType);
  }
}