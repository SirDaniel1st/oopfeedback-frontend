...
public class StationSimulation{
    ...
    public static void main(String[] args){
        //instancing a class or an object: ClassName InstanceName = new Class Constructor();
        ...
        } // anticipating that there will be some errors. If there is we catch and print
